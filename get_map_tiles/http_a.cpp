...
bool http_a::start_down_load(QString url,QString path,QString qt_path)
{
...
void http_a::replyFinished(QNetworkReply*)
{
...
void http_a::loadError(QNetworkReply::NetworkError)    //传输中的错误输出
{
    if(file!=NULL)
    {
...
void http_a::delaymsec(int msec)
{
