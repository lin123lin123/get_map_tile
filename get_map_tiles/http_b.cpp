...
bool http_b::start_down_load(QString url,QString path,QString qt_path)
{
    if(path!="")
    {
       file =new QFile(path);
...
void http_b::replyFinished(QNetworkReply*)
{
...
void http_b::loadError(QNetworkReply::NetworkError)    //传输中的错误输出
{
    if(file!=NULL)
    {
...
void http_b::delaymsec(int msec)
{
